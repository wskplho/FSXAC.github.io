...
var currentPlayer = "o";
var currentPlayerIcon = "https://cloud.githubusercontent.com/assets/4590693/5014345/375dcee0-6a52-11e4-9815-efbde61079cd.png"
...
function toggleCurrentPlayer(){
	...
	if (click != 9){
		if (currentPlayer == "x"){
			...
			currentPlayerIcon = "https://cloud.githubusercontent.com/assets/4590693/5014345/375dcee0-6a52-11e4-9815-efbde61079cd.png";
		}
		else{
			currentPlayer = "x";
			...
			currentPlayerIcon = "https://cloud.githubusercontent.com/assets/4590693/5014356/58200954-6a52-11e4-9a9b-ed0cc90cc6ea.png";
		}
	}
	else{
...
function restartGame(winner){
	...
	if (r == true) {
    	...
    	if (xWins > oWins){
    		// X Wins
    		document.getElementById("winnerMessage").src="https://cloud.githubusercontent.com/assets/4590693/5014361/5e750f16-6a52-11e4-9c24-918f7f1a0972.png";
    	}
    	else if (oWins > xWins){
    		// O Wins
    		document.getElementById("winnerMessage").src="https://cloud.githubusercontent.com/assets/4590693/5014351/4efacc42-6a52-11e4-9f49-0e44af1e7365.png";
    	}
    	else{
    		//Tie
    		document.getElementById("winnerMessage").src="https://cloud.githubusercontent.com/assets/4590693/5014354/53c223ba-6a52-11e4-80d3-ddfa8eccdd11.png";
    	}
